...
FitnessAppWrapper::FitnessAppWrapper()
{
	...
	cout << "Inside FitnessAppWrapper's constructor!" << endl << endl;
}
...
void FitnessAppWrapper::performUserSelection(const int& option)
{
	...
	case 1: // load weekly DP
		...
		cout << "Diet plans loaded from dietPlans.txt!" << endl << endl;
		break;
	case 2: // load weekly EP
		this->loadWeeklyExercisePlan();
		cout << "Exercise plans loaded from exercisePlans.txt!" << endl << endl;
		break;
	case 3: // store weekly DP
		this->storeWeeklyDietPlan();
		cout << "Diet plans stored to dietPlans.txt!" << endl << endl;
		break;
	case 4: // store weekly EP
		this->storeWeeklyExercisePlan();
		cout << "Exercise plans stored to exercisePlans.txt!" << endl << endl;
		break;
	...
	case 7: // edit daily DP
		...
		if (!success)
		{
			cout << "Could not find the diet plan specified!" << endl << endl;
		}
		break;
	case 8: // edit daily EP
		...
		if (!success)
		{
			cout << "Could not find the exercise plan specified!" << endl << endl;
		}
		break;
	case 9: // exit
		this->storeWeeklyDietPlan();
...
void FitnessAppWrapper::loadWeeklyExercisePlan() // this will call the private loadWeeklyPlan() function
{
	// "exercisePlans.txt" reading
...
void FitnessAppWrapper::displayWeeklyExercisePlan() // this will call the private displayWeeklyPlan() function
{
...
void FitnessAppWrapper::storeWeeklyExercisePlan() // this will call the private storeWeeklyPlan() function
{
	// "exercisePlans.txt" strorage
...
bool FitnessAppWrapper::editExercisePlan() // will prompt the user for the name of the plan to edit
{
	system("cls");
	this->displayWeeklyExercisePlan(); // provide the user with the plans
	...
	for (int day = 0; day < 7; ++day)
	{
		...
		{
			success = true;
			this->mEPList[day].editGoal(); // call the DietPlan object's editGoal ()
		}
	}
