...
class HW4Part2Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.opstack_output= {
            ...
            'test33': [30, 105, 180, 33, 77, 121, 4, 9, 14, 19, 25, 50, 75, 100, 125],
            'test34': [798453, 21, 23, 22, 24],
            'test35': [-3, 5, 128, 498 ,-15],
            'test36': [StringValue('(DNA)'), StringValue('(Va Dance)'), StringValue('(FLY)'), StringValue('(An foots)'), StringValue('(SOL)'), StringValue('(An class)')],
            'test37': [True, True]}
    ...
    def test_input32(self):
     ...
     # Start of the implementation of my 5 tests cases 
    ...
    def test_input34(self):
        ...
        /z 798453 def
          ...
          /three { /z 23 def } def
          /four { /z 24 def } def
          /five {/z 25 def} def z one z three z two z four z five
        """ 
    ...
    def test_input37(self):
        testinput37 = """
        (I am looking for a long string to make it complex but it is harder than I expected thank you if you were able to read all of it)
        dup dup dup dup dup 2 (hi) putinterval pop pop pop eq
        (It seems even harder to find a sentence that makes sence that is also long)
        dup dup dup dup dup 3 (hey) putinterval pop pop pop eq
        """ 
        ...
        for i in range(0,len(self.opstack_output[test_case])):
           ...
           # End of the implementation of my 5 tests cases 
